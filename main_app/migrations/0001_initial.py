# Generated by Django 4.1.3 on 2024-03-26 06:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='inquiry',
            name='Season',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='main_app.season'),
        ),
        migrations.AddField(
            model_name='inquiry',
            name='admin',
        ...
        migrations.AddField(
            model_name='inquiry',
            name='role',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='main_app.role'),
        ),
        migrations.CreateModel(
            name='FeedbackStaff',
            fields=[
        ...
        migrations.AddField(
            model_name='booking',
            name='car',
            field=models.ForeignKey(default=main_app.tests.get_default_car, on_delete=django.db.models.deletion.CASCADE, to='main_app.car'),
        ),
        migrations.AddField(
            model_name='booking',
            name='season',
            field=models.ForeignKey(default=main_app.tests.get_default_season, on_delete=django.db.models.deletion.CASCADE, to='main_app.season'),
        ),
        migrations.AddField(
            model_name='booking',
            name='user',
